...
import com.comfyui.monitor.handler.strategy.SystemPerformanceHandleStrategy;
import com.comfyui.monitor.handler.strategy.TaskCacheHandleStrategy;
import com.comfyui.monitor.handler.strategy.TaskCompleteHandleStrategy;
import com.comfyui.monitor.handler.strategy.TaskErrorHandleStrategy;
import com.comfyui.monitor.handler.strategy.TaskInterruptedHandleStrategy;
import com.comfyui.monitor.handler.strategy.TaskNodeUpdateHandleStrategy;
import com.comfyui.monitor.handler.strategy.TaskNumberUpdateHandleStrategy;
import com.comfyui.monitor.handler.strategy.TaskOutputHandleStrategy;
import com.comfyui.monitor.handler.strategy.TaskProgressHandleStrategy;
import com.comfyui.monitor.handler.strategy.TaskStartHandleStrategy;
...
public class ComfyWebSocketClientAutoConfigure {
    ...
    public Map<ComfyWebSocketMessageType, IComfyWebSocketTextHandleStrategy> textStrategyMapper(
            ...
            TaskErrorHandleStrategy taskErrorHandleStrategy,
        ...
        Map<ComfyWebSocketMessageType, IComfyWebSocketTextHandleStrategy> textStrategyMapper = new HashMap<>(10);
        //任务开始
        ...
        //任务错误
        textStrategyMapper.put(ComfyWebSocketMessageType.EXECUTION_ERROR, taskErrorHandleStrategy);
        //任务取消或被中断
